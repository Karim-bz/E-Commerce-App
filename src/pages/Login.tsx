export default function Login() {
  return (
    <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-2xl shadow-xl">
      ...
      <input className="w-full p-3 mb-4 border rounded-lg focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Email"/>
      ...
      <button className="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-accent transition">Login</button>
    </div>
  );
}
